...
<%
  ...
  ArrayList<WorkInfo> workinfos = (ArrayList<WorkInfo>)request.getAttribute("workinfos");
    ...
    <div class="col-md-9 pull-right">
      <table id="example" class="table table-bordered table-hover">
        ...
        <%for(int i = 0; i < workinfos.size(); i++ ) {%>
        	<tr>
            <td><%=workinfos.get(i).getSno() %></td>
            <td><%=workinfos.get(i).getDate()%></td>
            <td><%=workinfos.get(i).getWork() %></td>
          </tr>
        <%}%>
        </tbody>
      </table>
